...
DATA = [
    ...
    "org.jetbrains.compose.components:components-resources:sources:1.7.0-beta02",
    "org.jetbrains.compose.components:components-resources-desktop:sources:1.7.0-beta02",
