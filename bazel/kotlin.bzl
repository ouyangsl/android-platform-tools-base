...
def kotlin_library(
    ...
    # Target 17 explicitly to avoid JDK updates impacting generated bytecode (b/166472930).
    javacopts = ["--release", "17"] + javacopts
    kotlinc_opts = ["-jvm-target", "17"] + kotlinc_opts
