...
##############################################################################
##
##  ${COMMAND_NAME} start up script for Linux
##
##############################################################################
...
# Add default JVM options here. You can also use JAVA_OPTS and ${COMMAND_UPPER}_OPTS to pass JVM options to this script.
...
eval set -- $DEFAULT_JVM_OPTS $JAVA_OPTS $${COMMAND_UPPER}_OPTS -classpath "\"$CLASSPATH\"" ${MAIN_CLASS} "$APP_ARGS"
