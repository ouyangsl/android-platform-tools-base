...
public class ApkAnalyzerImplTest {
    ...
    public void dexCodeTest() throws IOException {
        ...
        assertEquals(
                ".class public Lcom/example/helloworld/HelloWorld;\n"
                    ...
                    + " hw:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;\n"
                    ...
                    + "\n"
                    + "    sput-object v0,"
                    + " Lcom/example/helloworld/HelloWorld;->hw:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;\n"
                    + "\n"
                    + "    return-void\n"
                    + ".end method\n"
                    + "\n"
                    ...
                    + " Lcom/example/helloworld/HelloWorld;->setContentView(I)V\n"
                    + "\n"
                    + "    .line 16\n"
                    + "    return-void\n"
                    + ".end method\n"
    ...
    public void dexCodeTestWithProguard() throws IOException {
        ...
        assertEquals(
                ".class public Loriginal/package/OriginalName;\n"
                    ...
                    + "# static fields\n"
                    + ".field private static"
                    + " originalField:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;\n"
                    + "    .annotation system Ldalvik/annotation/Signature;\n"
                    + "        value = {\n"
                    + "            \"Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater\",\n"
                    + "            \"<\",\n"
                    ...
                    + "\n"
                    + "    sput-object v0,"
                    + " Loriginal/package/OriginalName;->originalField:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;\n"
                    + "\n"
                    + "    return-void\n"
                    + ".end method\n"
                    + "\n"
                    ...
                    + "\n"
                    + "    invoke-virtual {p0, v0},"
                    + " Loriginal/package/OriginalName;->setContentView(I)V\n"
                    + "\n"
                    + "    .line 16\n"
                    + "    return-void\n"
                    + ".end method\n"
    ...
    public void dexPackagesTest() throws IOException {
        ...
        assertEquals(
                "P d 3\t7\t252\t<TOTAL>\n"
                    ...
                    + "M d 1\t1\t46\tcom.example.helloworld.HelloWorld void"
                    + " onCreate(android.os.Bundle)\n"
                    + "M r 0\t1\t8\tcom.example.helloworld.HelloWorld void setContentView(int)\n"
                    + "F d 0\t0\t18\tcom.example.helloworld.HelloWorld"
                    + " java.util.concurrent.atomic.AtomicIntegerFieldUpdater hw\n"
                    ...
                    + "M r 0\t1\t8\tjava.util.concurrent.atomic.AtomicIntegerFieldUpdater"
    ...
    public void manifestPermissionsTest() throws ProcessException {
        when(aaptInvoker.dumpBadging(apk.toFile()))
                .thenReturn(
                        Arrays.asList(
                                "package: name='com.example.packageName' versionCode='12345'"
    ...
    public void apkFeaturesTest() throws ProcessException {
                ...
                .thenReturn(
                        Arrays.asList(
                                ("uses-implied-permission:"
                                     ...
                                     + " reason='requested android.permission.RECORD_AUDIO"
                                     + " permission'\n")
                                        .split("\n")));
        ...
        assertEquals(
                "android.hardware.camera implied: requested android.permission.CAMERA permission\n"
                    ...
                    + "android.hardware.microphone implied: requested"
    ...
    public void apkCompareTest() throws IOException {
        ...
        assertEquals(
                "960\t649\t-311\t/\n"
                        ...
                        + "11\t11\t0\t/AndroidManifest.xml\n"
                        + "153\t0\t-153\t/instant-run.zip\n"
