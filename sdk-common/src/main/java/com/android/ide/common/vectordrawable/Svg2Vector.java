...
public class Svg2Vector {
    ...
    @NonNull
    private static SvgTree parse(String inputName, InputStream inputStream) throws Exception {
     ...
     *
     * @param svgInputName a name associated with the input SVG content, for example the file name
     *                     if the content is coming from a file
     ...
     *         VectorDrawable doesn't support or exception messages.
     */
    public static String parseSvgToXml(@NonNull String svgInputName,
            @NonNull InputStream svgInputStream, @NonNull OutputStream outStream) {
