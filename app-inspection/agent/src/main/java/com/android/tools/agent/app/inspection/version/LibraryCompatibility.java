 ...
 */
public final class LibraryCompatibility {

    public final ArtifactCoordinate artifact;
    public final String[] expectedClassNames;

    public LibraryCompatibility(ArtifactCoordinate artifact, String[] expectedClassNames) {
        this.artifact = artifact;
        this.expectedClassNames = expectedClassNames;
    }

    public String toVersionFileName() {
        return artifact.toVersionFileName();
    }
}
