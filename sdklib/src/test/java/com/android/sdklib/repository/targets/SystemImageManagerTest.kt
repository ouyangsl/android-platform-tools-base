...
public class SystemImageManagerTest extends TestCase {
    ...
    public void testSystemImageManager() {
        ...
        Collection<SystemImage> images = mgr.getImages();
    ...
    private static void recordPlatform13(Path sdkRoot) {
        ...
        InMemoryFileSystems.recordExistingFile(
                ...
                "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><ns2:sdk-repository"
                    ...
                    + "xmlns:ns5=\"http://schemas.android.com/sdk/android/repo/addon2/01\"><license"
                    + " id=\"license-2A86BE32\" type=\"text\">License Text\n"
                    + "</license><localPackage path=\"platforms;android-13\""
                    + " obsolete=\"false\"><type-details"
                    + " xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" "
                    + "xsi:type=\"ns2:platformDetailsType\"><api-level>13</api-level><layoutlib"
                    + " api=\"4\"/></type-details><revision><major>1</major></revision><display-name>API"
                    + " 13: Android 3.2 (Honeycomb)</display-name><uses-license"
                    + " ref=\"license-2A86BE32\"/><dependencies><dependency"
                    + " path=\"tools\"><min-revision><major>12</major></min-revision>"
    ...
    private static void recordGoogleTvAddon13(Path sdkRoot) {
        InMemoryFileSystems.recordExistingFile(
                ...
                "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><ns5:sdk-addon"
                    + " xmlns:ns2=\"http://schemas.android.com/sdk/android/repo/repository2/01\""
                    + " xmlns:ns3=\"http://schemas.android.com/sdk/android/repo/sys-img2/01\""
                    + " xmlns:ns4=\"http://schemas.android.com/repository/android/common/01\" "
                    + "xmlns:ns5=\"http://schemas.android.com/sdk/android/repo/addon2/01\"><license"
                    + " id=\"license-A06C75BE\" type=\"text\">Terms and Conditions\n"
                    + "</license><localPackage path=\"add-ons;addon-google_tv_addon-google-13\""
                    + " obsolete=\"false\"><type-details"
                    + " xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" "
                    + "xsi:type=\"ns5:addonDetailsType\"><api-level>13</api-level><vendor><id>google</id><display>Google"
                    + " Inc.</display></vendor><tag><id>google_tv_addon</id><display>Google TV"
                    + " Addon</display></tag><default-skin>720p</default-skin>"
                    + "</type-details><revision><major>1</major><minor>0</minor><micro>0</micro></revision><display-name>Google"
                    + " TV Addon, Android 13</display-name><uses-license"
                    + " ref=\"license-A06C75BE\"/></localPackage></ns5:sdk-addon>\n");
        InMemoryFileSystems.recordExistingFile(
    ...
    private static void recordSysImg23(Path sdkRoot) {
        ...
        InMemoryFileSystems.recordExistingFile(
                ...
                "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><ns3:sdk-sys-img"
                    + " xmlns:ns2=\"http://schemas.android.com/sdk/android/repo/repository2/01\""
                    + " xmlns:ns3=\"http://schemas.android.com/sdk/android/repo/sys-img2/01\""
                    + " xmlns:ns4=\"http://schemas.android.com/repository/android/common/01\" "
                    + "xmlns:ns5=\"http://schemas.android.com/sdk/android/repo/addon2/01\"><license"
                    + " id=\"license-A78C4257\" type=\"text\">Terms and Conditions\n"
                    + "</license><localPackage path=\"system-images;android-23;default;x86\" "
                    + "obsolete=\"false\"><type-details"
                    + " xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" "
                    + "xsi:type=\"ns3:sysImgDetailsType\"><api-level>23</api-level>"
                    + "<tag><id>default</id><display>Default</display></tag><abi>x86</abi></type-details><revision><major>5</major></revision><display-name>Intel"
                    + " x86 Atom System Image</display-name><uses-license"
                    + " ref=\"license-A78C4257\"/></localPackage></ns3:sdk-sys-img>\n");
    }
    ...
    private static void recordGoogleApisSysImg23(Path sdkRoot) {
        ...
        InMemoryFileSystems.recordExistingFile(
                ...
                "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><ns3:sdk-sys-img"
                    ...
                    + " xmlns:ns4=\"http://schemas.android.com/repository/android/common/01\" "
                    + "xmlns:ns5=\"http://schemas.android.com/sdk/android/repo/addon2/01\"><license"
                    + " id=\"license-9A5C00D5\" type=\"text\">Terms and Conditions\n"
                    + "</license><localPackage path=\"system-images;android-23;google_apis;x86_64\""
                    + " obsolete=\"false\"><type-details"
                    + " xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" "
                    + "xsi:type=\"ns3:sysImgDetailsType\"><api-level>23</api-level><tag><id>google_apis</id><display>Google"
                    + " APIs</display></tag><vendor><id>google</id><display>Google"
                    + " Inc.</display></vendor>"
                    + "<abi>x86_64</abi></type-details><revision><major>9</major></revision><display-name>Google"
                    + " APIs Intel x86 Atom_64 System Image</display-name><uses-license"
                    + " ref=\"license-9A5C00D5\"/></localPackage></ns3:sdk-sys-img>\n");
    }
