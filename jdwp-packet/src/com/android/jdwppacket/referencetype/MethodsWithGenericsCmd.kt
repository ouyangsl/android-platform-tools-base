...
data class MethodsWithGenericsCmd(val refType: Long) : Cmd(ReferenceType.MethodsWithGeneric) {
  companion object {

    @JvmStatic
    fun parse(reader: MessageReader): MethodsWithGenericsCmd {
      return MethodsWithGenericsCmd(reader.getReferenceTypeID())
    }
  }
