...
data class SignatureCmd(val refType: Long) : Cmd(ReferenceType.Signature) {
  companion object {

    @JvmStatic
    fun parse(reader: MessageReader): SignatureCmd {
      return SignatureCmd(reader.getReferenceTypeID())
    }
  }
