...
class AllClassesWithGenericsCmd : Cmd(VirtualMachine.AllClassesWithGeneric) {

  companion object {

    @JvmStatic
    fun parse(reader: MessageReader): AllClassesWithGenericsCmd {
      return AllClassesWithGenericsCmd()
    }
  }

  override fun equals(other: Any?): Boolean {
    return other is AllClassesWithGenericsCmd
  }
