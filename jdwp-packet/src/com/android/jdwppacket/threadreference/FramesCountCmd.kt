...
data class FramesCountCmd(val threadID: Long) : Cmd(ThreadReference.FrameCount) {
  ...
  companion object {
    @JvmStatic
    fun parse(reader: MessageReader): FramesCountCmd {
      return FramesCountCmd(reader.getThreadID())
    }
  }
}
