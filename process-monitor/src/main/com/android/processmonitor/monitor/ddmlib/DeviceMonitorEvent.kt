...
internal sealed class DeviceMonitorEvent {
    ...
    /**
     * Sent when a device is [com.android.ddmlib.IDevice.DeviceState.ONLINE] and ready to accept ADB
     * request.
     */
     ...
     * cases. Also note this can be invoked even if a [Online] was never sent.
     */
