...
class TestingManagerTest {
  ...
  @Mock lateinit var testClient: Testing

  @Mock lateinit var testMatrixClient: TestMatrices

  @Mock lateinit var mockMatrixCreate: TestMatrices.Create

  @Mock lateinit var mockMatrixGet: TestMatrices.Get

  @Mock lateinit var mockCatalog: Testing.TestEnvironmentCatalog

  @Mock lateinit var mockCatalogGet: Testing.TestEnvironmentCatalog.Get
  ...
  fun test_createTextMatrixRun() {
    ...
    val result = manager.createTestMatrixRun("my_project", mockMatrix, "aabbcc")
