...
class SetupTaskActionTest {
  ...
  @Mock lateinit var catalog: AndroidDeviceCatalog
  ...
  fun setup() {
    ...
    outDirectory = project.layout.buildDirectory.dir("test-dir").get().apply { asFile.mkdirs() }
      ...
      .thenReturn(
        listOf(
          ...
          AndroidModel().apply {
            id = "someOtherDevice"
            name = "something"
            supportedVersionIds = listOf("25", "26", "27", "28", "29", "30", "31", "32", "33")
          },
        )
      )
