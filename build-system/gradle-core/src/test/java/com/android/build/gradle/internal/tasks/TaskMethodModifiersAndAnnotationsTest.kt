    ...
    fun `check for public task setters`() {
        ...
        val currentPublicSetters =
            listOf(
                ...
                "com.android.build.gradle.internal.tasks.PreviewScreenshotTestTask::setRecordGoldenOption",
                "com.android.build.gradle.internal.tasks.PreviewScreenshotTestTask::setVariantName",
