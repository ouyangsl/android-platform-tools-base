...
private fun runComposeCliRender(settingsFile: File): String {
    ...
    val command = listOf("$javaHome/bin/java", "-Dlayoutlib.thread.profile.timeoutms=10000", "-cp", "compose-preview-renderer.jar", "com.android.tools.render.compose.MainKt", settingsFile.absolutePath)
