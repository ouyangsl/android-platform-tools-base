 ...
 * [imagePath] relative path of the screenshot image in the output directory - if successful,
 * image will be created in the output folder with this path, else it is used to identify the exact
 * screenshot that failed. This file separators in this path are OS dependent.
