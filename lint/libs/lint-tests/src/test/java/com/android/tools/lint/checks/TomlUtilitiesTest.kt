...
class TomlUtilitiesTest {
    ...
    fun testPickLibraryName() {
        ...
        libraryName("com-google-foo3", "com.google:foo:1.0", "Foo", "Google-foo", "com-google-foo", "com-google-foo2")
        ...
        libraryName("com-google-foo-1_0", "com.google:foo:1.0", "foo-1_0", "google-foo-1_0", includeVersions = true)
        libraryName("com-google-foo-1_0-2", "com.google:foo:1.0", "foo-1_0", "google-foo-1_0", "com-google-foo-1_0", includeVersions = true)
        libraryName("com-google-foo-1_0-3", "com.google:foo:1.0", "foo-1_0", "google-foo-1_0", "com-google-foo-1_0", "com-google-foo-1_0-2", includeVersions = true)

        libraryName("kotlin-reflect", "org.jetbrains.kotlin:kotlin-reflect:1.0")
        libraryName("jetbrains-kotlin-reflect", "org.jetbrains.kotlin:kotlin-reflect:1.0", "kotlin-reflect")
    ...
    fun testPickVersionName() {
        ...
        versionName("com-google-fooBar", "com.google:foo-bar:1.0", "Foo-Bar", "fooBar", "fooBarVersion", "google-fooBar")
        versionName("com-google-fooBar", "com.google:foo-bar:1.0", "Foo-Bar", "fooBar", "fooBarVersion", "google-fooBar", "google-fooBarVersion")
        versionName("com-google-fooBar2", "com.google:foo-bar:1.0", "Foo-Bar", "fooBar", "fooBarVersion", "google-fooBar", "google-fooBarVersion", "com-google-fooBar")
        versionName("com-google-fooBar3", "com.google:foo-bar:1.0", "Foo-Bar", "fooBar", "fooBarVersion", "google-fooBar", "google-fooBarVersion", "com-google-fooBar", "com-google-fooBar2")
        ...
        versionName("com-google-foo-bar2", "com.google:foo-bar:1.0", "foo-bar", "google-foo-bar", "com-google-foo-bar")
        versionName("com-google-foo-bar3", "com.google:foo-bar:1.0", "foo-bar", "google-foo-bar", "com-google-foo-bar", "com-google-foo-bar2")
    }
    ...
    private fun versionName(
        ...
        check(expected, coordinateString, { gc, map, _ -> pickVersionVariableName(gc, map) }, includeVersions, *variableNames)
    }

    private fun check(
        expected: String,
        coordinateString: String,
        suggestName: (gc: GradleCoordinate, libraryMap: Map<String, LintTomlValue>, includeVersionInKey: Boolean) -> String,
