...
public class ImplicitUnprotectedIntentSendDetectorTest extends LintDetectorTest {
    ...
    public void testSendEmptyIntentInCall() {
        lint().files(
                ...
                .expectMatches(ImplicitUnprotectedIntentSendDetector.IMPLICIT_INTENT_MESSAGE);
    }
    ...
    public void testCreateImplicitPendingIntent() {
        lint().files(
                ...
                .expectCount(1, Severity.WARNING)
                .expectMatches(
                        ImplicitUnprotectedIntentSendDetector.IMPLICIT_PENDING_INTENT_MESSAGE);
    }
    ...
    protected List<Issue> getIssues() {
        return Arrays.asList(
                ImplicitUnprotectedIntentSendDetector.IMPLICIT_INTENT_SENDED_UNPROTECTED,
