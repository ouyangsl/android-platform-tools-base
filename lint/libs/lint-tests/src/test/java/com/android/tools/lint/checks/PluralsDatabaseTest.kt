  ...
  companion object {
    private fun dumpDatabaseTables() {
      ...
      for (language in languages) {
        ...
        val quantitySet = db.getRelevant(language)
      ...
      val output = buildString {
        appendLine("    /** Set of language codes relevant to plurals data */")
        appendLine("    private val LANGUAGE_CODES = arrayOf(")
    ...
    private fun printWhen(
      ...
      val output = buildString {
        ...
        appendLine("""
          |    private fun getExampleForQuantity$quantityName(language: String): String? {
