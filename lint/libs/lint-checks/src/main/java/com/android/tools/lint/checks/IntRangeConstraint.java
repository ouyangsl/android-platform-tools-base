...
class IntRangeConstraint extends RangeConstraint {
    ...
    @NonNull
    public static IntRangeConstraint create(
            @NonNull JavaContext context,
            @NonNull UAnnotation annotation) {
        assert INT_RANGE_ANNOTATION.equals(annotation.getQualifiedName());
        long from = getAnnotationLongValue(context, annotation, ATTR_FROM, Long.MIN_VALUE);
        long to = getAnnotationLongValue(context, annotation, ATTR_TO, Long.MAX_VALUE);
        return new IntRangeConstraint(from, to);
    }
