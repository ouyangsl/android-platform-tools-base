...
/**
 * This detector covers taskAffinity issues: - Warnings will be supplied when an activity already
 * has a task affinity set
 *
 * <p>We recommend to set the task affinity of the application to an empty value, since this can
 * prevent different attacks such as phishing or denial of service.
 *
...
public class TaskAffinityDetector extends Detector implements Detector.XmlScanner {
    ...
    @VisibleForTesting
    public static final String ACTIVITY_TASK_AFFINITY_SET_MESSAGE =
            "SM12: Common Task Affinity | Do not set taskAffinity";

    public static final Issue ACTIVITY_TASK_AFFINITY_SET =
            Issue.create(
                            "CommonTaskAffinity",
                            ...
                            5,
                            Severity.WARNING,
                            new Implementation(TaskAffinityDetector.class, Scope.MANIFEST_SCOPE))
                    .addMoreInfo(
                            "https://www.usenix.org/system/files/conference/usenixsecurity15/sec15-paper-ren-chuangang.pdf")
                    .addMoreInfo(
                            "https://bitbucket.org/secure-it-i/android-app-vulnerability-benchmarks/wiki/Using%20Task%20Affinity%20to%20launch%20Denial-of-service%20or%20Phishing%20attacks%20in%20Android")
    ...
    public static final Issue APPLICATION_TASK_AFFINITY_NOT_EMPTY =
            Issue.create(
                            "CommonTaskAffinity",
    ...
    public void visitElement(@NonNull XmlContext context, @NonNull Element element) {
        ...
        if (isApplicationNode(element)) {
            if (taskAffinityAttr == null || !taskAffinityAttr.getValue().equals("")) {
                context.report(
                        APPLICATION_TASK_AFFINITY_NOT_EMPTY,
                        element,
            ...
            if (taskAffinityAttr != null) {
                context.report(
                        ACTIVITY_TASK_AFFINITY_SET,
                        taskAffinityAttr,
                        context.getLocation(taskAffinityAttr),
                        ACTIVITY_TASK_AFFINITY_SET_MESSAGE);
            }
        }
    }
    ...
    private Attr findTaskAffinityAttr(@NonNull Element activityElement) {
        ...
        Attr taskAffinityAttribute =
                activityElement.getAttributeNodeNS(NS_RESOURCES, ATTR_TASK_AFFINITY);
