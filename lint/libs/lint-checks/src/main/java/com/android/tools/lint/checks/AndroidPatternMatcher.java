...
// Copy of android.os.PatternMatcher with a small set of changes
//  (1) Changed package to lint
//  (2) Changed class name from PatternMatcher to AndroidPatternMatcher
//  (3) Removed import to android.util.Log which was unused and its log tag
//  (4) Removed the Parcelable interface and implementation methods
