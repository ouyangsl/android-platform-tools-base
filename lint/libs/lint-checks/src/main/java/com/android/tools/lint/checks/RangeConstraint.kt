...
abstract class RangeConstraint {
  ...
  /** Remove the given [other] constraint from this constraint, if possible. */
  ...
  /** Whether this range has infinite size (e.g. missing either upper or lower bound. */
