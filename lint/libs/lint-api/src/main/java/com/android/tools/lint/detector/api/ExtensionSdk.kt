...
class ExtensionSdk(val name: String, val id: Int, val reference: String?) : Comparable<ExtensionSdk> {
    ...
    companion object {
        ...
        /**
         * SDK id's 1 through 999999 are reserved for platform SDKs,
         * where the id matches the corresponding API level
         */
