...
public class UElementHandler {
    ...
    public void visitClassLiteralExpression(@NonNull UClassLiteralExpression uClassLiteralExpression) {
    ...
    public void visitDeclarationsExpression(@NonNull UDeclarationsExpression uDeclarationsExpression) {
    ...
    public void visitObjectLiteralExpression(@NonNull UObjectLiteralExpression uObjectLiteralExpression) {
        error(UObjectLiteralExpression.class);
    }

    public void visitParenthesizedExpression(@NonNull UParenthesizedExpression uParenthesizedExpression) {
    ...
    public void visitSwitchClauseExpression(@NonNull USwitchClauseExpression uSwitchClauseExpression) {
    ...
    public void visitTypeReferenceExpression(@NonNull UTypeReferenceExpression uTypeReferenceExpression) {
