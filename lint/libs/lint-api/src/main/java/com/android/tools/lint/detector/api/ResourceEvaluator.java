...
public class ResourceEvaluator {
    ...
    public static ResourceUrl getResource(
        ...
        return new ResourceEvaluator(evaluator).getResource(element, context);
    }
    ...
    public static EnumSet<ResourceType> getResourceTypes(
            ...
            @NonNull UastContext context,
            @NonNull UElement element) {
        return new ResourceEvaluator(evaluator).getResourceTypes(element, context);
    }
     ...
     */
    @Nullable
    public ResourceUrl getResource(@Nullable UElement element, @NonNull UastContext context) {
        if (element == null) {
            return null;
        }
        ...
        if (element instanceof UIfExpression) {
            ...
            Object known = ConstantEvaluator.evaluate(null, expression.getCondition(), context);
            if (known == Boolean.TRUE && expression.getThenExpression() != null) {
                return getResource(expression.getThenExpression(), context);
            } else if (known == Boolean.FALSE && expression.getElseExpression() != null) {
                return getResource(expression.getElseExpression(), context);
            }
            ...
            return getResource(parenthesizedExpression.getExpression(), context);
            ...
            if ((selector instanceof UCallExpression)) {
                ...
                if (function != null && containingClass != null) {
                    ...
                    if ((CLASS_RESOURCES.equals(qualifiedName)
                        ...
                        if (!args.isEmpty()) {
                            return getResource(args.get(0), context);
                        }
                    }
                }
            }
        ...
        if (element instanceof UReferenceExpression) {
            ...
            if (resolved instanceof PsiVariable) {
                ...
                if (lastAssignment != null) {
                    return getResource(lastAssignment, context);
                }
    ...
    public EnumSet<ResourceType> getResourceTypes(@Nullable UElement element,
        ...
        if (element instanceof UIfExpression) {
            ...
            Object known = ConstantEvaluator.evaluate(null, expression.getCondition(), context);
            if (known == Boolean.TRUE && expression.getThenExpression() != null) {
                return getResourceTypes(expression.getThenExpression(), context);
            } else if (known == Boolean.FALSE && expression.getElseExpression() != null) {
                return getResourceTypes(expression.getElseExpression(), context);
            } else {
                EnumSet<ResourceType> left = getResourceTypes(
                        expression.getThenExpression(), context);
                EnumSet<ResourceType> right = getResourceTypes(
                        expression.getElseExpression(), context);
                if (left == null) {
                    return right;
                } else if (right == null) {
                    return left;
            ...
            UParenthesizedExpression parenthesizedExpression = (UParenthesizedExpression) element;
            return getResourceTypes(parenthesizedExpression.getExpression(), context);
        } else if ((element instanceof UQualifiedReferenceExpression && allowDereference)
            ...
            if ((probablyCallExpression instanceof UCallExpression)) {
                ...
                if (method != null && containingClass != null) {
                    ...
                    if ((CLASS_RESOURCES.equals(qualifiedName)
                        ...
                        List<UExpression> args = call.getValueArguments();
                        if (!args.isEmpty()) {
                            types = getResourceTypes(args.get(0), context);
                            if (types != null) {
                                return types;
                            }
                        }
        ...
        if (element instanceof UReferenceExpression) {
            ...
            if (resolved instanceof PsiVariable) {
                ...
                UElement lastAssignment =
                        UastLintUtils.findLastAssignment(variable, element, context);

                if (lastAssignment != null) {
                    return getResourceTypes(lastAssignment, context);
                }
