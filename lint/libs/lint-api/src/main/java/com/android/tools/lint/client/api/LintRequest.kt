...
open class LintRequest(
  ...
  @JvmField protected var scope: EnumSet<Scope>? = null

  @JvmField protected var platform: EnumSet<Platform>? = null
  ...
  /**
   * Gets the scope to use; lint checks which require a wider scope set will be ignored
   *
