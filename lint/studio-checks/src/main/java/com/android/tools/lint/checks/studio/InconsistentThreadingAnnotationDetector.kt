...
class InconsistentThreadingAnnotationDetector : Detector(), SourceCodeScanner {
    ...
    companion object Issues {
        private val threadingAnnotations = listOf(
        ...
        private val IMPLEMENTATION = Implementation(
            InconsistentThreadingAnnotationDetector::class.java, Scope.JAVA_FILE_SCOPE
        )
    ...
    override fun visitAnnotationUsage(
        ...
        val overriddenMethodAnnotation =
            context.evaluator.getAllAnnotations(overriddenMethod)
        ...
        if (overriddenMethodAnnotation == null) {
            ...
            val overriddenMethodClassAnnotation =
                context.evaluator.getAllAnnotations(overriddenMethodClass)
                    .map { it.qualifiedName }
                    .firstOrNull { threadingAnnotations.contains(it) }
