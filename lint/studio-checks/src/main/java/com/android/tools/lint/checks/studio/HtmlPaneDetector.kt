...
/** Detect incorrect construction of JEditorPanes with text/html content type. */
class HtmlPaneDetector : Detector(), SourceCodeScanner {

  companion object Issues {
    private val IMPLEMENTATION = Implementation(HtmlPaneDetector::class.java, Scope.JAVA_FILE_SCOPE)
  ...
  private fun setsEditorKit(element: UExpression): Boolean {
    val method = element.getParentOfType<UMethod>(UMethod::class.java, true) ?: return false
